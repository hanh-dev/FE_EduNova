...
const AddStudentForm = ({ setStudents, userToEdit, setAddForm }) => {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal">
        <button className="close-button" onClick={()=>setAddForm(false)}>×</button>
        <h2>{userToEdit ? 'Update User' : 'Add New User'}</h2>
